    ...
    try:
        ...
        for chat_id in chat_ids:
            try:
                ...
                error_count += 1
                logger.error(f"Ошибка при отправке вечернего сообщения в чат {chat_id}: {e}")
        
        logger.info(f"Вечерние сообщения отправлены: успешно {sent_count}, ошибок {error_count}")
