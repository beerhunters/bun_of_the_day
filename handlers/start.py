...
from aiogram.types import Message, ChatMemberAdministrator, ChatMemberOwner, InlineKeyboardMarkup, InlineKeyboardButton
...
async def start(message: Message):
    ...
    if message.chat.type == "private":
        ...
        if from_user.id == ADMIN:
            ...
            # Обычное сообщение для пользователей
            await message.answer(
